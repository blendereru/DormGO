...
class APIManager {
    ...
    func sendProtectedRequest(completion: @escaping (ProtectedResponse?) -> Void) {
        let url = URL(string: "https://9da1-2-134-108-133.ngrok-free.app/api/protected")!
...
struct RegistrationView: View {
    ...
    func longPollForToken(email:String) {
        ...
        guard let url = URL(string: "https://9da1-2-134-108-133.ngrok-free.app/api/check-confirmation/\(email)") else {
...
//        // You can further configure the request here, such as adding headers or body
    ...
    func sendRegistrationRequest(email: String, password: String) {
        ...
        let url = URL(string: "https://9da1-2-134-108-133.ngrok-free.app/api/signup")!
